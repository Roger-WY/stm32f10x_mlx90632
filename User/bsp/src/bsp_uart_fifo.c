...
static void UartVarInit(void)
{
    ...
    #endif
    #if ((MODBUS_CFG_HOST_EN == 1) || (MODBUS_CFG_SLAVE_EN == 1))
	//g_tUart1.ReciveNew = ModbusSlave_Uart_ReciveNew;		/* 接收到新数据后的回调函数 */
	//g_tUart1.ReciveNew = ModbusHost_Uart_ReciveNew;		/* 接收到新数据后的回调函数 */
    #else
    ...
    #endif
    #if ((MODBUS_CFG_HOST_EN == 1) || (MODBUS_CFG_SLAVE_EN == 1))
	g_tUart2.ReciveNew = ModbusSlave_Uart_ReciveNew;		/* 接收到新数据后的回调函数 */
	//g_tUart2.ReciveNew = ModbusHost_Uart_ReciveNew;		/* 接收到新数据后的回调函数 */
    #else
