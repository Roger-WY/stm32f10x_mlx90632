...
* 描述： Modbus从机设备 宏定义配置
*/
#define MODBUS_SLAVE_UARTX  COM2           /* 从机通讯使用的串口号 */
#define MODBUS_SLAVE_BAUD	UART2_BAUD     /* 从机通讯使用的波特率 */

#define MODBUS_SLAVE_ADDR	1              /* 定义Modbus从站地址 */

#define MODBUS_DEBUG        0              /* 是否输出Modbus调试信息 */
#endif
